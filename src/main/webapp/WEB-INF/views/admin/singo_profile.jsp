...
<section>
    ...
    <table width="700" border="1" align="center">
        ...
        <tr>
            ...
            <td><a href="#" style="color:blue; font-size:14px; font-weight:600;"> 클릭 </a></td>
        </tr>
        <tr>
            <td> 비고 </td>
            <td>
                ...
                <c:if test="${svo.state==0}">
                    <div id="singo" onclick="location='singo_up?id=${svo.id}&panmae_id=${svo.panmae_id}&singo_id=${svo.singo_id}'"> 신고처리 </div>
