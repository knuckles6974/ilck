...
<nav>
    ...
    <div id="menu1">
        <a href="../mypage/mypage"><img src="../resources/img/account.png" id="account"><span id="acc">내상점</span></a> <span id="vline">|</span>
        <a href=""><img src="../resources/img/talk.png" id="talk"><span id="tal">블루TALK</span></a> <span id="vline">|</span>
        <a href=""><img src="../resources/img/sell.png" id="sell"><span id="sel">판매하기</span></a>
    </div>
    ...
    <ul id="main">
        ...
        <li id="m1"><a href="">최신상품</a></li>
        <li id="m2"><a href="">우리동네</a></li>
...
<head>
    ...
    <script>
        function wishview()
        {
            document.getElementById("mymenu_view")
        }
        /*
...
<section>
    <form id="profile">
        <div class="proleft">
			...
			<form name="aaa" method="post" action="ok" enctype="multipart/form-data"> -->
                <label for="image"><div id="image_container">
                    <%
                    ...
                    {
                    %>
                    <img src="img/<%=request.getParameter("fname") %>" width="100">
                    <%
                        }
                    %>

                </div>  </label>
                <form method="post" action="aa.jsp" name="aa" enctype="multipart/form-data">
                    <!--<input type="file" name="image" id="image"  style="display:none"/>-->
                    <!-- <input type="file" id="file-input" style="display: none;" onchange="readURL(this);"> -->
                </form>
            </div>
        ...
        <div class="proright">
            ...
            <div class="prorsecond">
                <div class="progaib">가입일: ${mvo.writeday}</div>
                <div class="prophone">연락처: ${mvo.phone}</div>
                <div class="proemail">이메일: ${mvo.email}</div>
            </div>
            <div class="prorsecond">
                <div class="probsu">게시글: 23</div>
                <div class="propsu">판매물품: 16</div>
            </div>
